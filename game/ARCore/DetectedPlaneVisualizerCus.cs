...
namespace GoogleARCore.Examples.Common
{
    ...
    /// </summary>
    public class DetectedPlaneVisualizerCus : MonoBehaviour
    {
        ...
        public void Initialize(DetectedPlane plane)
        {
            ...
            meshCollider.tag = Constants.tagARPlane;
            meshCollider.gameObject.layer = LayerMask.NameToLayer(Constants.layerMRcollider);
