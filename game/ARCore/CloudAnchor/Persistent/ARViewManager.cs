...
namespace MRGun.PersistentCloudAnchors
{
    ...
    public class ARViewManager : MonoBehaviour
    {
        ...
        /// <summary>
        /// Callback handling "Cancel" button click event for input field.
        /// </summary>
        public void OnCancelButtonClicked()
        {
            DebugText.text = "Canceled Cloud Anchor.\nPlease wait...";
        ...
        public void OnShareButtonClicked()
        {
            ...
            SingleObj<PersistentCloudAnchorsCreator>.obj.sharePCA(_hostedCloudAnchor.Id, 
            (response) =>
            {
                if(response == "success")
                {
                    DebugText.text += "\nshare success !!";
                    Invoke("delayReload", 3f);
                }
            });
        }
        ...
        private void PerformHitTest(Vector2 touchPos)
        {
            ...
            if (_anchorComponent != null)
            {
                //Instantiate(CloudAnchorPrefab, _anchorComponent.transform); //建立錨點
                if(!SingleObj<PersistentCloudAnchorsCreator>.obj.addPCA(_anchorComponent.transform))   //test
                    return;
                SingleObj<PersistentCloudAnchorsCreator>.obj.switchSelPanel();
